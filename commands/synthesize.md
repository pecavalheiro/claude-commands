...
3. **Load and Analyze Requirements**
   ...
   - Parse the following sections:
     ...
     - Acceptance Criteria
     - Ultrathink all the above
   - Read `03-context-findings.md` and ultrathink it for technical context
   - Read `metadata.json` and ultrathink for related features and context files
...
5. **Generate Todo List**
   Ultrathink and create a structured todo list from the implementation plan:
   ```markdown
